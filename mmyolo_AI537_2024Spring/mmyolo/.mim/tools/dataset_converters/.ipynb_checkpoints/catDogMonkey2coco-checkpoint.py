...
if __name__ == '__main__':
    ...
    convert_balloon_to_coco('data/cat_dog_monkey_dataset/train/',
                            'data/cat_dog_monkey_dataset/train.json')
    convert_balloon_to_coco('data/cat_dog_monkey_dataset/val/',
                            'data/cat_dog_monkey_dataset/val.json')
    convert_balloon_to_coco('data/cat_dog_monkey_dataset/test/',
